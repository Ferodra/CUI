...
function BE:SetBarSmoothFactor(factor)
...
function BE:Create()
	...
	self.Bar = E:CreateBar("Bar_Experience", BarStrata, BarX, BarY, BarPoint, self.Holder, nil, nil, nil)
