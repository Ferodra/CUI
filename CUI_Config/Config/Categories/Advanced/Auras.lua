			...
			buttonGroup = {
				...
				args = {
					...
					borderUseClassColor = {
						...
						set = function(info, value) CO.db.profile.unitframe[type].borderUseClassColor.useClassColor = value; E:LoadModule("Auras"):LoadConfig(); end,
						hidden = (type == "debuffs"),
					},
					borderColor = {
						name = L["BorderColor"],
					...
					useMasque = {
						...
						get = function() return CO.db.char.unitframe[type].useMasque end,
						set = function(info, value) CO.db.char.unitframe[type].useMasque = value; CD:ShowNotification("CHARACTERSETTING_NOTIFICATION") end,
					},
				},
			},
			moverGroup = {
