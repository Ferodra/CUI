...
local CO, CD, UF, BA = E:LoadModules("Config", "Config_Dialog", "Unitframes", "Bar_Auras")
	...
	args = {
		...
		layoutBarsGroup = {
			...
			args = {
				...
				xpNormal 			= GetOptionsTable_LayoutBars(L["XPBarNormal"], "barExperienceNormal", 100, E:LoadModule("Bar_Experience").LoadConfig),
				xpRested 			= GetOptionsTable_LayoutBars(L["XPBarRested"], "barExperienceRested", 200, E:LoadModule("Bar_Experience").LoadConfig),
				...
				azOverlay 			= GetOptionsTable_LayoutBars(L["AzeriteBarOverlay"], "barAzerite", 350, E:LoadModule("Bar_Azerite").LoadConfig),
				newLine = {type = "description", name = "", order = 1000},
				reset = {
					type = "execute",
					name = L["Reset"],
					order = 1001,
					func = function() for k,v in pairs(E.ConfigDefaults.profile.colors.layoutBars) do for key, color in pairs(v) do CO.db.profile.colors.layoutBars[k][key] = color end end; E:LoadModule("Bar_Experience"):LoadConfig(); E:LoadModule("Bar_Azerite"):LoadConfig(); end,
				},
			},
		},
		zoneGroup = {
